...
export default function Footer() {
  ...
  return (
    <footer>
      <section className="padding-block-650">
        <div className="container">
          <div className="even-columns gap-1-5">
            ...
            <nav className="box">
              <ul role="list" className="flex f-column justify-center m-auto p-0 gap-0-75">

                <li className="p-1 t-center"><Link to="/" className="text-white fw-300 fw-regular"><span className="mr-1"><i className="fas fa-home"></i></span> {t('home')}</Link> </li>
                <li className="p-1 t-center"><Link to="/about-us" className="text-white fw-300 fw-regular">{t('about_us')}</Link> </li>
                <li className="p-1 t-center"><Link to="/soon" className="text-white fw-300 fw-regular">{t('reports')}</Link> </li>
                <li className="p-1 t-center"><Link to="/soon" className="text-white fw-300 fw-regular">{t('projects')}</Link> </li>
                <li className="p-1 t-center"><Link to="/soon" className="text-white fw-300 fw-regular">{t('contributors')}</Link> </li>
              </ul>
            </nav>
            <div className="box">
	...
	<path className="elementor-shape-fill" d="M15.6,13.2c0-0.1,4.3,0,6.7,0.5c2.4,0.5,5,1.9,5,2c0,0.1-2.7-0.8-5.1-1.4	C19.9,13.7,15.7,13.3,15.6,13.2z"></path>
      ...
      <section className="copyright-links bg-secondary p-4">
        <div className="container">
          <div className="flex justify-between align-items gap-1-5" style={{flexWrap : 'wrap'}}>
            <div className="flex items-center">
              <p className="text-white fs-300 fw-semi-bold">
                {t('all_rights_reserved')}
              </p>
            </div>
            <div>
              <div className="social-icons flex items-center">
                <a href="" className="bg-secondary m-1 text-white circle">
